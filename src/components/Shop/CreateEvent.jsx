...
const CreateEvent = () => {
  ...
  return (
    <div className="w-[90%] 800px:w-[50%] bg-white  shadow h-[80vh] rounded-[4px] p-3 overflow-y-scroll">
      <h5 className="text-[30px] font-Poppins text-center">Создать событие</h5>
      {/* create event form */}
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Введите названия вашего события..."
          />
        </div>
        <br />
        <div>
        ...
        <div>
          <label className="pb-2">
            Начало события <span className="text-red-500">*</span>
          </label>
          <input
            type="date"
            name="price"
        ...
        <div>
          <label className="pb-2">
            Конец события <span className="text-red-500">*</span>
          </label>
          <input
            type="date"
            name="price"
